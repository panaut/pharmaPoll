...
namespace PollQuestionnaire.UI.Web
{
    public class DefaultSettings
    {
        public static void CreateDefaultDbUser()
        {
            ...
            //try
            //{                
            //    SqlConnection conn = new SqlConnection(@"Data Source=tcp:159.8.31.20,780;Initial Catalog=patque_net_questionnaire;User ID=patque_net_pqadmin;UserId=patque_net_pqadmin;password=Paki2804!;");
            //    conn.Open();
